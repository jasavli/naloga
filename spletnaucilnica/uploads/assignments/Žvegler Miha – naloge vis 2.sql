...
--
-- Gostitelj: 127.0.0.1
-- Čas nastanka: 01. nov 2024 ob 13.53
...
(8, 3, 1, 6, 'naloge vis', 'uploads/assignments/Žvegler Miha – naloge vis.pdf', '2024-11-01 12:11:11');
...
(3, 1, 'naloge vis', 'Rešite naloge in jih oddaje v .pdf obliki.', '2024-10-30 12:16:58', '2024-11-14 12:16:00');
...
--
ALTER TABLE `gradiva`
  MODIFY `ID_gradiva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `komentarji_naloge`
  MODIFY `ID_komentarja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT tabele `naloge`
--
ALTER TABLE `naloge`
  MODIFY `ID_naloge` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT tabele `naloge_predmet`
--
ALTER TABLE `naloge_predmet`
  MODIFY `ID_naloge_predmet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `uporabniki`
  MODIFY `ID_uporabnika` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
